<!--
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=venom&height=300&color=gradient&text=Ardan&fontColor=ffffff&fontSize=90&stroke=0000&animation=twinkling&fontAlignY=40&desc=aka%20dannfrd&descAlignY=60&descSize=30" width="100%" />
  </div>
  
  <p align="center">
  <a href="https://github.com/dannfrd"><img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&size=25&duration=3500&pause=300&color=6C5CE7&center=true&vCenter=true&width=600&lines=console.log('Hello+World!');+//+I'm+Ardan;import+{+Experience+}+from+'web-development';;composer+require+ardan/awesome-code;const+FRONTEND+=+['React',+'TypeScript',+'Tailwind',+'Figma'];" alt="Typing SVG" /></a>
</p> 
-->  
...
![OpBento](https://firebasestorage.googleapis.com/v0/b/smartkaksha-fe32c.appspot.com/o/opbento%2Fdannfrd857b4.png?alt=media)
...
class Developer {
  ...
  workWith() {
    return {
      ...
      devTools: ["VS Code", "Git", "GitHub", "Vercel"],
      currentlyLearning: ["React Native", "GraphQL", "Node.js"]
    };
  }
}

// Initialize
const ardan = new Developer();
ardan.sayHi();
```
...
<div align='center'>
  <img src="https://komarev.com/ghpvc/?username=dannfrd&label=Profile%20visits&color=6C5CE7&style=for-the-badge" alt="Profile visits" />
</div>
